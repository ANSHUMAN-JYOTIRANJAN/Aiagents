          ...
          `}
                        ...
                        <div className="my-3">
                            ...
                            <div className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-3 py-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-slate-500">{Math.ceil(selectedFile.size / 1024)
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <button
                            onClick={toggleMic}
                            className={`flex items-center justify-center w-8 h-8 rounded-lg transition-all cursor-pointer${isListening ? "bg-red-500 text-white" : "text-slate-600 hover:bg-white/[0.05]"} `}>{isListening
                                ?
                                <MicOff size={14} /> :
                                <Mic size={14} />}
                        </button>
